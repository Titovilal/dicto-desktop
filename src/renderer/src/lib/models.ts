...
export const AI_MODELS_INFO: Record<keyof typeof AI_MODELS, ModelInfo> = {
  ...
  'openai/gpt-4o-mini': {
    name: 'GPT-4o Mini',
    description: 'Similar to Gemini Flash, but with slightly less reasoning capabilities.',
    bestFor: ['Basic text processing', 'Simple summaries', 'Quick translations']
  }
} as const

export const getModelId = (key: keyof typeof AI_MODELS): string => key
export const getModelName = (key: keyof typeof AI_MODELS): string => AI_MODELS[key]
