"""Settings persistence, panel navigation, and window behavior for the main window.

`SettingsMixin` covers: loading/saving config-backed settings and their change
handlers, the audio test monitor, UI-language retranslation, settings/models
panel open/close, frameless-window dragging, and the close-to-tray handler.
...
class SettingsMixin:
    """Settings I/O, audio test, i18n, panels, and window behavior."""

    # ── Event filter (hover icons) ──────────────────────────
